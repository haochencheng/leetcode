...
//        List<Integer> list = Arrays.asList(-10,9,20,null,null,15,7);
        ...
        TreeNode p = treeNode.findByVal(2);
        TreeNode q = treeNode.findByVal(4);
        System.out.println(lowestCommonAncestor.lowestCommonAncestor(treeNode, p, q));
    }
