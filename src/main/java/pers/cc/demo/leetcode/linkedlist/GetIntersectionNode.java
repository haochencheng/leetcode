...
public class GetIntersectionNode {
    ...
    public static void main(String[] args) {
        ...
        ListNode listNode1 = ListNode.fillNode(Arrays.asList(9, 7, 2, 5, 4, 1, 3));
        GetIntersectionNode getIntersectionNode = new GetIntersectionNode();
        ListNode result = getIntersectionNode.getIntersectionNode(listNode, listNode1);
    ...
    public ListNode getIntersectionNode(ListNode headA, ListNode headB) {
        ...
        while (headB != null) {
            if (hashMap.containsKey(headB.val) && hashMap.get(headB.val) == headB) {
                return headB;
            }
            headB = headB.next;
        }
